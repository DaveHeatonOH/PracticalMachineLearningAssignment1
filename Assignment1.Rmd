...
Based on the above confusion matrix, it would appear that the model is extremely adept at predicting the activity based on an accuracy of .9985 (0.9917 - 0.9993) and p < 0.001. The out of sample error rate is 0.0015 based on the 1 - accuracy. 
